...
public class Utils {
    ...
    public static var FLUID_ITEM_TYPES as IFluidStack[IIngredient] = {
        (<item:minecraft:milk_bucket> as IIngredient): <fluid:minecraft:milk> * 1000,
        (<item:minecraft:water_bucket> as IIngredient): <fluid:minecraft:water> * 1000,
    };

    static {
        if (loadedMods.isModLoaded("create")) {
            FLUID_ITEM_TYPES[ (<item:minecraft:honey_bottle> as IIngredient) ] = <fluid:create:honey> * 1000;
        }
        if (loadedMods.isModLoaded("blue_skies")) {
            FLUID_ITEM_TYPES[ (BracketHandlers.getItem("blue_skies:ventium_milk_bucket") as IIngredient) ] = <fluid:minecraft:milk> * 1000;
            FLUID_ITEM_TYPES[ (BracketHandlers.getItem("blue_skies:ventium_water_bucket") as IIngredient) ] = <fluid:minecraft:water> * 1000;
        }
        if (loadedMods.isModLoaded("farmersdelight")) {
            FLUID_ITEM_TYPES[ (BracketHandlers.getItem("farmersdelight:milk_bottle") as IIngredient) ] = <fluid:minecraft:milk> * 250;
            if (loadedMods.isModLoaded("create_central_kitchen")) {
                FLUID_ITEM_TYPES[ (BracketHandlers.getItem("farmersdelight:tomato_sauce") as IIngredient) ] = <fluid:create_central_kitchen:tomato_sauce> * 250;
            }
        }
        if (loadedMods.isModLoaded("miners_delight")) {
            FLUID_ITEM_TYPES[ (BracketHandlers.getItem("miners_delight:milk_cup") as IIngredient) ] = <fluid:minecraft:milk> * 1000;
            FLUID_ITEM_TYPES[ (BracketHandlers.getItem("miners_delight:water_cup") as IIngredient) ] = <fluid:minecraft:water> * 1000;
        }
        if (loadedMods.isModLoaded("cyclic")) {
            FLUID_ITEM_TYPES[ (BracketHandlers.getItem("cyclic:milk_bottle") as IIngredient) ] = <fluid:minecraft:milk> * 250;
            if (loadedMods.isModLoaded("create")) {
                FLUID_ITEM_TYPES[ (BracketHandlers.getItem("cyclic:honey_bucket") as IIngredient) ] = <fluid:create:honey> * 1000;
            }
        }
        if (loadedMods.isModLoaded("thermal")) {
            FLUID_ITEM_TYPES[ (BracketHandlers.getItem("thermal:syrup_bucket") as IIngredient) ] = <fluid:thermal:syrup> * 1000;
            FLUID_ITEM_TYPES[ (BracketHandlers.getItem("thermal:syrup_bottle") as IIngredient) ] = <fluid:thermal:syrup> * 250;
            if (loadedMods.isModLoaded("create_central_kitchen") && loadedMods.isModLoaded("thermal_cultivation")) {
                FLUID_ITEM_TYPES[ (BracketHandlers.getItem("thermal:tomato_sauce") as IIngredient) ] = <fluid:create_central_kitchen:tomato_sauce> * 625;
            }
        }
        if (loadedMods.isModLoaded("create_central_kitchen")) {
            FLUID_ITEM_TYPES[ (BracketHandlers.getItem("create_central_kitchen:tomato_sauce_bucket") as IIngredient) ] = <fluid:create_central_kitchen:tomato_sauce> * 1000;
        }
        if (loadedMods.isModLoaded("create_enchantment_industry")) {
