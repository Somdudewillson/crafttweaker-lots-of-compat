...
var T3_TURRET_COMPONENT = <item:minecraft:echo_shard> as IIngredient | <tag:item:lots_of_compat:diamond_circuits>;
var T2_TURRET_COMPONENT = <item:minecraft:echo_shard> as IIngredient | <tag:item:lots_of_compat:gold_circuits>;
