...
var BASE_INGREDIENT_TO_MOLTEN_MAP as FractionalFluid[IIngredient] = {
    <tag:item:forge:storage_blocks/iron> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_iron>, 810),
    ContextualConstants.IRON_INGOT as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_iron>, 90),
    <tag:item:forge:plates/iron> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_iron>, 90),
    <tag:item:forge:nuggets/iron> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_iron>, 10),
    <tag:item:forge:gears/iron> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_iron>, 360),

    <tag:item:forge:storage_blocks/gold> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_gold>, 810),
    ContextualConstants.GOLD_INGOT as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_gold>, 90),
    <tag:item:forge:plates/gold> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_gold>, 90),
    <tag:item:forge:nuggets/gold> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_gold>, 10),
    <tag:item:forge:gears/gold> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_gold>, 360),

    <tag:item:forge:storage_blocks/copper> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_copper>, 810),
    <tag:item:forge:ingots/copper> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_copper>, 90),
    <tag:item:forge:plates/copper> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_copper>, 90),
    <tag:item:forge:nuggets/copper> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_copper>, 10),
    <tag:item:forge:gears/copper> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_copper>, 360),

    <tag:item:forge:storage_blocks/tin> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_tin>, 810),
    <tag:item:forge:ingots/tin> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_tin>, 90),
    <tag:item:forge:plates/tin> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_tin>, 90),
    <tag:item:forge:nuggets/tin> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_tin>, 10),
    <tag:item:forge:gears/tin> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_tin>, 360),

    <tag:item:forge:storage_blocks/aluminum> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_aluminum>, 810),
    <tag:item:forge:ingots/aluminum> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_aluminum>, 90),
    <tag:item:forge:plates/aluminum> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_aluminum>, 90),
    <tag:item:forge:nuggets/aluminum> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_aluminum>, 10),
    <tag:item:forge:gears/aluminum> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_aluminum>, 360),

    <tag:item:forge:storage_blocks/lead> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_lead>, 810),
    <tag:item:forge:ingots/lead> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_lead>, 90),
    <tag:item:forge:plates/lead> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_lead>, 90),
    <tag:item:forge:nuggets/lead> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_lead>, 10),
    <tag:item:forge:gears/lead> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_lead>, 360),

    <tag:item:forge:storage_blocks/silver> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_silver>, 810),
    <tag:item:forge:ingots/silver> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_silver>, 90),
    <tag:item:forge:plates/silver> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_silver>, 90),
    <tag:item:forge:nuggets/silver> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_silver>, 10),
    <tag:item:forge:gears/silver> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_silver>, 360),

    <tag:item:forge:storage_blocks/nickel> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_nickel>, 810),
    <tag:item:forge:ingots/nickel> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_nickel>, 90),
    <tag:item:forge:plates/nickel> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_nickel>, 90),
    <tag:item:forge:nuggets/nickel> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_nickel>, 10),
    <tag:item:forge:gears/nickel> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_nickel>, 360),

    <tag:item:forge:storage_blocks/zinc> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_zinc>, 810),
    <tag:item:forge:ingots/zinc> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_zinc>, 90),
    <tag:item:forge:plates/zinc> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_zinc>, 90),
    <tag:item:forge:nuggets/zinc> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_zinc>, 10),
    <tag:item:forge:gears/zinc> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_zinc>, 360),

    <tag:item:forge:storage_blocks/uranium> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_uranium>, 810),
    <tag:item:forge:ingots/uranium> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_uranium>, 90),
    <tag:item:forge:plates/uranium> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_uranium>, 90),
    <tag:item:forge:nuggets/uranium> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_uranium>, 10),
    <tag:item:forge:gears/uranium> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_uranium>, 360),

    <tag:item:forge:storage_blocks/bronze> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_bronze>, 810),
    <tag:item:forge:ingots/bronze> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_bronze>, 90),
    <tag:item:forge:plates/bronze> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_bronze>, 90),
    <tag:item:forge:nuggets/bronze> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_bronze>, 10),
    <tag:item:forge:gears/bronze> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_bronze>, 360),

    <tag:item:forge:storage_blocks/brass> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_brass>, 810),
    <tag:item:forge:ingots/brass> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_brass>, 90),
    <tag:item:forge:plates/brass> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_brass>, 90),
    <tag:item:forge:nuggets/brass> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_brass>, 10),
    <tag:item:forge:gears/brass> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_brass>, 360),

    <tag:item:forge:storage_blocks/steel> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_steel>, 810),
    <tag:item:forge:ingots/steel> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_steel>, 90),
    <tag:item:forge:plates/steel> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_steel>, 90),
    <tag:item:forge:nuggets/steel> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_steel>, 10),
    <tag:item:forge:gears/steel> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_steel>, 360),

    <tag:item:forge:storage_blocks/netherite> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_netherite>, 810),
    <tag:item:forge:ingots/netherite> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_netherite>, 90),
    <tag:item:forge:plates/netherite> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_netherite>, 90),
    <tag:item:forge:nuggets/netherite> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_netherite>, 10),
    <tag:item:forge:gears/netherite> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_netherite>, 360),

    <tag:item:forge:storage_blocks/emerald> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_emerald>, 900),
    <tag:item:forge:gems/emerald> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_emerald>, 100),
    <tag:item:forge:gears/emerald> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_emerald>, 400),

    <tag:item:forge:storage_blocks/quartz> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_quartz>, 400),
    <tag:item:forge:gems/quartz> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_quartz>, 100),
    <tag:item:forge:gears/quartz> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_quartz>, 400),

    <tag:item:forge:storage_blocks/amethyst> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_amethyst>, 400),
    <tag:item:forge:gems/amethyst> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_amethyst>, 100),
    <tag:item:forge:gears/amethyst> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_amethyst>, 400),

    <tag:item:forge:storage_blocks/diamond> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_diamond>, 900),
    <tag:item:forge:gems/diamond> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_diamond>, 100),
    <tag:item:forge:gears/diamond> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_diamond>, 400),

    <tag:item:forge:ingots/netherite_scrap> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_debris>, 90),
    <tag:item:forge:nuggets/netherite_scrap> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_debris>, 10),
    <tag:item:forge:gears/netherite_scrap> as IIngredient: new FractionalFluid(<fluid:tconstruct:molten_debris>, 360)
};
...
var BURNABLE_INGREDIENTS as IIngredient[] = [
    <tag:item:minecraft:logs> as IIngredient,
    <tag:item:minecraft:planks> as IIngredient,
    <tag:item:forge:rods/wooden> as IIngredient,
    <tag:item:minecraft:wooden_slabs> as IIngredient,
    <tag:item:minecraft:wooden_stairs> as IIngredient,
    <tag:item:forge:fences/wooden> as IIngredient,
    <tag:item:forge:fence_gates/wooden> as IIngredient,
    <tag:item:minecraft:wooden_pressure_plates> as IIngredient,
    <tag:item:minecraft:wooden_buttons> as IIngredient,
    <tag:item:forge:normal_stone> as IIngredient,
    <tag:item:forge:feathers> as IIngredient,
    <tag:item:forge:torches> as IIngredient,
