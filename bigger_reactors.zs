...
if ( (loadedMods.isModLoaded("thermal") && loadedMods.isModLoaded("thermal_dynamics") && loadedMods.isModLoaded("thermal_expansion")) || (DIAMOND_CIRCUITS.elements.length > 0) ) {
    ...
    craftingTable.addShaped("reactor_terminal_circuit", <item:biggerreactors:reactor_terminal>, [
        [ContextualConstants.IRON_INGOT, <tag:item:forge:ingots/graphite>, ContextualConstants.IRON_INGOT],
        [<tag:item:forge:ingots/graphite>, DIAMOND_CIRCUITS, <tag:item:forge:ingots/graphite>],
        [ContextualConstants.IRON_INGOT, <tag:item:forge:ingots/graphite>, ContextualConstants.IRON_INGOT],
    ]);
    craftingTable.addShaped("reactor_terminal_signalum", <item:biggerreactors:reactor_terminal>, [
        [<tag:item:forge:ingots/graphite>, <tag:item:forge:ingots/signalum>, <tag:item:forge:ingots/graphite>],
        [<tag:item:forge:ingots/signalum>, <tag:item:forge:gems/diamond>, <tag:item:forge:ingots/signalum>],
        [<tag:item:forge:ingots/graphite>, <tag:item:forge:ingots/signalum>, <tag:item:forge:ingots/graphite>],
    ]);
}
...
if ( (loadedMods.isModLoaded("thermal") && loadedMods.isModLoaded("thermal_dynamics") && loadedMods.isModLoaded("thermal_expansion")) || (DIAMOND_CIRCUITS.elements.length > 0) ) {
    ...
    craftingTable.addShaped("turbine_terminal_circuit", <item:biggerreactors:turbine_terminal>, [
        [<tag:item:forge:gems/quartz>, <tag:item:forge:ingots/graphite>, <tag:item:forge:gems/quartz>],
    ...
    craftingTable.addShaped("turbine_terminal_signalum", <item:biggerreactors:turbine_terminal>, [
        [<tag:item:forge:gems/quartz>, <tag:item:forge:ingots/signalum>, <tag:item:forge:gems/quartz>],
        [<item:biggerreactors:blutonium_ingot>, <tag:item:forge:gems/diamond>, <item:biggerreactors:blutonium_ingot>],
        [<tag:item:forge:ingots/signalum>, <tag:item:forge:ingots/signalum>, <tag:item:forge:ingots/signalum>],
    ]);
}
...
if ( (loadedMods.isModLoaded("thermal") && loadedMods.isModLoaded("thermal_dynamics") && loadedMods.isModLoaded("thermal_expansion")) || (DIAMOND_CIRCUITS.elements.length > 0) ) {
    ...
    craftingTable.addShaped("heat_exchanger_terminal_circuit", <item:biggerreactors:heat_exchanger_terminal>, [
        ...
        [<tag:item:forge:ingots/copper>, DIAMOND_CIRCUITS, <tag:item:forge:ingots/copper>],
    ]);
